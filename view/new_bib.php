<?
$cheditor = "no"; $_dep = array(4,12);
$_tit = array('WORK','New_bib');
            ...
            <article class="cont cont1">
                <div class="inner">
                    <div class="pf__topTextZone">
                        ...
                        <span class="pf__title">한국불교미디어정보센터</span>
                        <a href="https://lbh6154.cafe24.com/mediacenter/" target="_blank" class="pf__link">
                    ...
                    <div class="pf__imgZone">
                        <div class="desktop__img">
                            <div class="img__box">
                                <img src="<?=DIR?>/img/view/new_bib_desktop.JPG" alt="new_bib Desktop img">
                            </div>
                        </div>
                        ...
                        <div class="info__wr">
                            ...
                            <p class="text">
                                한국불교미디어정보센터는 제가 입사 후 처음 맡아 진행하였던 반응형 웹 사이트에서 새롭게 리뉴얼 작업하였습니다.<br> 
                                작업은 개인 프로젝트로 기획부터 디자인, 퍼블리싱을 모두 맡아 진행하였습니다.<br> 
                                새롭게 리뉴얼하려고 도전했으며 메인 색상도 검정색으로 변경하여 작업을 진행하였고 웹표준과 접근성 모두 준수하여 작업에 임했습니다.
                            </p>
                        </div>

                        <div class="transform__img">
                            <div class="tablet__img row__img">
                                 <img src="<?=DIR?>/img/view/new_bib_tablet.JPG" alt="new_bib tablet img">
                            </div>
                            <div class="mobile__img row__img">
                                 <img src="<?=DIR?>/img/view/new_bib_mobile.JPG" alt="new_bib mobile img">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <article class="cont cont2">
                <div class="inner">
                    <div class="fontStyle__wr">
                        <span class="cont__title font_family_wr">Typography : NanumSquareNeo</span>

                        <div class="top">
                            <div class="row">
                                <p class="font">NanumSquareNeo_Mediacenter</p>
                            </div>
                        </div>
                    ...
                    <ul class="footer__btn__wr">
                        ...
                        <li class="link_wr">
                            ...
                            <a href="https://lbh6154.cafe24.com/mediacenter/" target="_blank" class="text">view</a>
                        </li>
                    </ul>
                </div>
            </article>

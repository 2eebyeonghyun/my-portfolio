<?
$cheditor = "no"; $_dep = array(4,6);
$_tit = array('WORK','kntcc');
            ...
            <article class="cont cont1">
                <div class="inner">
                    <div class="pf__topTextZone">
                        ...
                        <span class="pf__title">경남금연지원센터</span>
                        <a href="https://lbh6154.cafe24.com/nosmoke/main/index.php" target="_blank" class="pf__link">
                    ...
                    <div class="pf__imgZone">
                        <div class="desktop__img">
                            <div class="img__box">
                                <img src="<?=DIR?>/img/view/kntcc_desktop.JPG" alt="kntcc Desktop img">
                            </div>
                        </div>
                        ...
                        <div class="info__wr">
                            ...
                            <p class="text">
                                경남금연지원센터 프로젝트는 기존에 있던 금연상담 블로그 페이지를 새롭게 웹 사이트 형식으로 제작한 프로젝트입니다.<br> 
                                프로젝트는 총 2명의 제작 인원이 참여했으며 작업기간은 3주정도 소요하였습니다.<br> 
                                제가 맡은 업무는 기획, 디자인, 퍼블리싱 업무를 맡아 진행하였고 일러스트와 포토샵, 브라켓을 통해 작업을 진행하였습니다.
                            </p>
                        </div>

                        <div class="transform__img">
                            <div class="tablet__img row__img">
                                 <img src="<?=DIR?>/img/view/kntcc_tablet.JPG" alt="kntcc tablet img">
                            </div>
                            <div class="mobile__img row__img">
                                 <img src="<?=DIR?>/img/view/kntcc_mobile.JPG" alt="kntcc mobile img">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <article class="cont cont2">
                <div class="inner">
                    <div class="fontStyle__wr">
                        <span class="cont__title font_family_wr">Typography : ibm-plex-sans</span>

                        <div class="top">
                            <div class="row">
                                <p class="font ibm-plex-sans_text ibm-plex-sans_text_bold">ibm-plex-sans 경남금연지원센터</p>
                            </div>
                        </div>
                        ...
                        <div class="bot">
                            <div class="left row">
                                ...
                                <p class="font ibm-plex-sans_text">AaBb</p>
                            </div>

                            <div class="right row">
                                <span class="detail__txt">LETTERS + NUMBERS</span>
                                <ul class="font_list ibm-plex-sans_text_list">
                                    <li>Aa</li>
                                    <li>Bb</li>
                                    <li>Cc</li>
                                    <li>Dd</li>
                    ...
                    <ul class="footer__btn__wr">
                        ...
                        <li class="link_wr">
                            ...
                            <a href="https://lbh6154.cafe24.com/nosmoke/main/index.php" target="_blank" class="text">view</a>
                        </li>
                    </ul>
                </div>
            </article>

<?
$cheditor = "no"; $_dep = array(4,11);
$_tit = array('WORK','New_kidsmarinepark');
            ...
            <article class="cont cont1">
                <div class="inner">
                    <div class="pf__topTextZone">
                        ...
                        <span class="pf__title">키즈마린파크</span>
                        <a href="https://lbh6154.cafe24.com/kidsmarinepark/" target="_blank" class="pf__link">
                    ...
                    <div class="pf__imgZone">
                        <div class="desktop__img">
                            <div class="img__box">
                                <img src="<?=DIR?>/img/view/new_kidsmarinepark_desktop.JPG" alt="new_kidsmarinepark Desktop img">
                            </div>
                        </div>
                        ...
                        <div class="info__wr">
                            ...
                            <p class="text">
                                해당 프로젝트는 기존에 제가 작업을 했던 키즈마린파크를 새롭게 리뉴얼하여 제작한 웹 사이트입니다.<br> 
                                사이트는 반응형(데스크탑, 테블릿, 모바일) 웹 사이트로 제작하였습니다.<br> 
                                개인 프로젝트여서 기획, 디자인, 퍼블리싱 모두 맡아 진행을 하게 되었고 작업 기간은 총 2주정도 소요하였습니다.
                            </p>
                        </div>

                        <div class="transform__img">
                            <div class="tablet__img row__img">
                                 <img src="<?=DIR?>/img/view/new_kidsmarinepark_tablet.JPG" alt="new_kidsmarinepark tablet img">
                            </div>
                            <div class="mobile__img row__img">
                                 <img src="<?=DIR?>/img/view/new_kidsmarinepark_mobile.JPG" alt="new_kidsmarinepark mobile img">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <article class="cont cont2">
                <div class="inner">
                    <div class="fontStyle__wr">
                        ...
                        <div class="top">
                            <div class="row">
                                <p class="font pretendard__text pretendard__text_bold">Pretendard__키즈마린파크</p>
                            </div>
                        </div>
                    ...
                    <ul class="footer__btn__wr">
                        ...
                        <li class="link_wr">
                            ...
                            <a href="https://lbh6154.cafe24.com/kidsmarinepark/" target="_blank" class="text">view</a>
                        </li>
                    </ul>
                </div>
            </article>
